#include <Wire.h>
#include <BricktronicsMegashield.h> // These two lines let the Arduino sketch use the Bricktronics library code that simplifies working with motors and sensors.
